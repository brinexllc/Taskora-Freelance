...
export default function ResetPasswordPage() {
  ...
  async function change(e) { e.preventDefault(); setLoading(true); setError(''); try { const data = await confirmPasswordReset({ email, reset_token: token, password, password_confirm: confirm }); setSession(data); router.replace('/dashboard'); } catch (err) { setError(err.message); } finally { setLoading(false); } }
