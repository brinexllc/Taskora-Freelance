...
CLICK_FISCALIZATION_ENABLED = env_bool("CLICK_FISCALIZATION_ENABLED", True)
CLICK_FISCAL_ITEM_NAME = os.getenv("CLICK_FISCAL_ITEM_NAME", "").strip()
CLICK_FISCAL_SPIC = os.getenv("CLICK_FISCAL_SPIC", "").strip()
CLICK_FISCAL_PACKAGE_CODE = os.getenv("CLICK_FISCAL_PACKAGE_CODE", "").strip()
CLICK_FISCAL_VAT_PERCENT = os.getenv("CLICK_FISCAL_VAT_PERCENT", "").strip()
CLICK_FISCAL_TIN = os.getenv("CLICK_FISCAL_TIN", "").strip()
CLICK_FISCAL_PINFL = os.getenv("CLICK_FISCAL_PINFL", "").strip()
